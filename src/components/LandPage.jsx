...
const LandPage = () => {
  return (
    <main className='w-screen h-full p-[120px] bg-secondary grid grid-cols-1 md:grid-cols-2 justify-center space-x-0 md:space-x-[150px]'>
      ...
      <form action="" className="max-w-[520px] w-full mx-auto bg-white border-2 p-8 rounded-lg shadow-sm font-body font-medium flex flex-col gap-6">
